...
![Figure 1. Governed execution chain (graphic summary).](../assets/stamp-paper/fig_golden_path.png)

**PEV ordering and H6 (Allow+Ledger) invariants (rendered “equation” images):**

![Equation 1. Validate → receipt → execute on the golden path.](../assets/stamp-paper/eq_ordering.png)

![Equation 2. Allow requires durable ledger evidence (else deny).](../assets/stamp-paper/eq_allow_ledger.png)
...
![Figure C-1. Governed execution chain (graphic summary).](../assets/stamp-paper/fig_golden_path.png)
